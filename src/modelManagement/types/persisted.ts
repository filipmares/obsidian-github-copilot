 ...
 */
export type AgentType = "opencode" | "claude" | "codex" | "github-copilot";

/**
 * The broader set used for per-backend model curation: the agents
 ...
 *   "github-copilot" → GitHub Copilot CLI agent picker
 *
